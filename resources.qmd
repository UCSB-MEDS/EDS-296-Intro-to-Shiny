...
- **[Do No Harm Guide: Applying Equity Awareness in Data Visualization](https://www.urban.org/sites/default/files/publication/104296/do-no-harm-guide.pdf)**, by [Jonathan Schwabish](https://www.urban.org/author/jonathan-schwabish) and [Alice Feng](https://alicefeng.github.io/) -- a guide for for approaching data work (and particularly visualizations) through a lens of diversity, equity, and inclusion 
