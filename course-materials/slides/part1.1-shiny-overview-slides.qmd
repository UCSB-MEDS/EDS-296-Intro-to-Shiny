...
[Worldbank-Shiny](https://github.com/aguimaraesduarte/WorldBank-Shiny){target="_blank"} app to visualize fertility rate vs. life expectancy from 1960 to 2015, by [Andre Duarte](https://github.com/aguimaraesduarte){target="_blank"}
:::
...
::: {.footer}
Read more about frameworks on [codecademy](https://www.codecademy.com/resources/blog/what-is-a-framework/){target="_blank"}
:::
...
Shiny apps are composed in *two* parts: [**(1)**]{.teal-text} a **web page** that displays the app to a user (i.e. the **user interface**, or **UI** for short), and [**(2)**]{.teal-text} a **computer** that powers the app (i.e. the **server**)
...
- Shiny comes with a set of of [standard widgets](https://shiny.rstudio.com/tutorial/written-tutorial/lesson3/){target="_blank"} (see left), but you can also explore widget extensions using a variety of other packages (e.g. [`{shinyWidgets}`](https://github.com/dreamRs/shinyWidgets){target="_blank"}, [`{DT}`](https://rstudio.github.io/DT/){target="_blank"}, [`{plotly}`](https://plotly.com/r/){target="_blank"})
:::
...
Check out Garrett Grolemund's article, [How to understand reactivity in R ](https://shiny.rstudio.com/articles/understanding-reactivity.html){target="_blank"} for a more detailed overview of Shiny reactivity.
...
[[{{< fa droplet title="a water droplet" >}}]{.teal-text} [HydroTech Helper](https://danielkerstan.shinyapps.io/usgs_water_data/){target="_blank"} ([video tutorial](https://www.youtube.com/watch?v=t8AUNpIb4eE){target="_blank"}), *by MEDS 2022 alum, [Daniel Kerstan](https://www.linkedin.com/in/daniel-kerstan-5b162321b/){target="_blank"}, developed during his time as a USGS Hydrologic Technician* -- access real-time monitoring of USGS hydrology sites and equipment]{.body-text-s}

[[{{< fa water title="three water waves" >}}]{.teal-text} [Marine Mammal Bycatch Impacts Exploration Tool](https://msiple.shinyapps.io/mmrefpoints/){target="_blank"} ([source code](https://github.com/mcsiple/mmrefpoints){target="_blank"}) *by [Dr. Megsie Siple](https://www.linkedin.com/in/margaret-siple-66157211/){target="_blank"} and colleagues* -- compute population projections under different bycatch mortality levels]{.body-text-s}

[[{{< fa book-open-reader title="a person holding a book up to their face" >}}]{.teal-text} [Novel-gazing](https://msiple.shinyapps.io/NovelGazingApp/){target="_blank"} ([source code](https://github.com/mcsiple/novelgazing){target="_blank"}) *by [Dr. Megsie Siple](https://www.linkedin.com/in/margaret-siple-66157211/){target="_blank"}* -- a fun app for exploring your Goodreads data, inspired by community ecology]{.body-text-s}

<br>

[**Apps which are no longer deployed:**]{.body-text-m .teal-text}

[[{{< fa fish-fins title="a fish with fins" >}}]{.teal-text} [Moorea Coral Reef LTER Shiny Application](https://shinyapps.bren.ucsb.edu/ShinyAppMooreaViz/){target="_blank"} ([source code](https://shinyapps.bren.ucsb.edu/ShinyAppMooreaViz/){target="_blank"}), *by MEDS 2022 alumni, [Allie Cole](https://www.linkedin.com/in/allie-ingrid-cole-60351a1ba/){target="_blank"}, [Felicia Cruz](https://www.linkedin.com/in/cruz-felicia/){target="_blank"}, [Jake Eisaguirre](https://jake-eisaguirre.github.io/){target="_blank"} & [Charles Henrickson](https://www.linkedin.com/in/charles-hendrickson-0001a0223/){target="_blank"} as part of their MEDS capstone project* -- visualize spatial and temporal patterns of coral reef stressors surrounding Moorea, French Polynesia]{.body-text-s}

---

##  {#built-in-examples data-menu-title="Built-in Examples"}

[The Shiny packages comes with 11 built-in examples]{.slide-title3}
