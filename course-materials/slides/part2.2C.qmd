...
It's usually valuable (and important) to provide some background information / context for your app -- the landing page of your app can be a great place for this (but certainly doesn't have to be). We're going to add text to our app's landing page (i.e. the **About this App** page) so that it looks like the example below:
