...
[Add the server function to `server.R` and the three main UI components (header, sidebar, and body) to our dashboard page -- to keep things organized, **I recommend splitting the UI into separate pieces, then combining them into a `dashboardPage` the end of `ui.R`**]{.body-text-s}
    ...
    tabItem(tabName = "dashboard",
            ...
            fluidRow(
              ...
              box(width = 4,
                  ...
                  sliderInput(inputId = "temp_slider_input", label = "Average lake bed temperature (°C):",
