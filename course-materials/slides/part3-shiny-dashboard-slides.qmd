...
<p class="body-text-s">**(a)** a `dashboardHeader` with the name of your app</p>
<p class="body-text-s">**(b)** a `dashboardSidebar` with two `menuItem`s</p>
<p class="body-text-s">**(c)** a landing page with background information about your app</p>
<p class="body-text-s">**(d)** an interactive *and* reactive `leaflet` map</p>
:::
...
[Setup your shiny dashboard]{.slide-title2}
...
[Pre-processing data is critical]{.slide-title3}
...
[Sketch out our dashboard UI]{.slide-title2}
