...
[The Shiny workflow allows app developers to iterate quickly!]{.slide-title2}
...
But what if you have 20 apps, or many team members? It gets **challenging** to remember all the features you need to test, or how each works. Things get lost in translation with manually experimenting (e.g. can you explain to your coworker *all* of your app's features and make sure that they manually test it properly?)
...
"Captur[ing] desired behavior of your code in a way that you can automatically verify that it keeps working the way you expect" ([Mastering Shiny Ch 21](https://mastering-shiny.org/scaling-testing.html))

---

`{shinytest2}`

- (unit) regression testing for Shiny applications
  ...
  fluidRow(
    ...
    sidebarLayout(
      ...
      mainPanel(
        ...
        textOutput(outputId = "first_letter_output")
