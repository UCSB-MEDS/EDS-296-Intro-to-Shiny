...
[[**(3)**]{.teal-text} Lastly, let's create a `global.R` file within `two-file-app/` and add dependencies (right now, that's just loading `{shiny}`). Run your app as we did earlier.]{.body-text-s}
