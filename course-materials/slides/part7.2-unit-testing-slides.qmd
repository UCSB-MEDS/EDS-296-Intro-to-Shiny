...
Before we dive into writing any tests, it's super helpful to inspect your app and *importantly*, **jot down (in your own words) the expected behaviors of your application**. These will form the basis of the [assertions](https://en.wikipedia.org/wiki/Test_assertion) made in your tests.
