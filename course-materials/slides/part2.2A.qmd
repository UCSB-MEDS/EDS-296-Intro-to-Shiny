...
::: {.column width="50%"}
```{r, filename="~/scratch/practice_script_app2.R"}
#| eval: false
#| echo: true
#..........................load packages.........................
...
[**Remember the three rules for building reactive outputs:** **(1)** save objects you want to display to `output$<id>`, **(2)** build reactive objects using a `render*()` function, and **(3)** access input values with `input$<id>`:]{.body-text-s}
...
- [If needed, reference your [practice script](https://ucsb-meds.github.io/EDS-430-Intro-to-Shiny/course-materials/slides/part2.2-two-file-app-slides.html#/app2-trout-plot) to remind yourself how you planned to filter and plot your data]{.body-text-s}
