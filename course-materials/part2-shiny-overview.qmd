...
We'll be referencing the following slide deck for Part 2:

::: {.center-text}
[{{< fa person-chalkboard title="A person motioning at a chalkboard" >}} Part 2 slides](../slides/part2-shiny-overview-slides.qmd){.btn role="button" target="_blank"} 
:::
