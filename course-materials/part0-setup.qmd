...
we do assume general familiarity with the R programming language. We also ask that you arrive with all necessary software installed / configured. See below, or the [MEDS Installation Guide](https://ucsb-meds.github.io/MEDS-installation-guide/){target="_blank"} (steps 1 - 7) for detailed instructions.
:::
...
3. The required following R packages installed. Install / update them all at once by running the following in your console:
