...
install.packages(pkgs = c("here", "tidyverse", "shiny", "shinydashboard", "shinyWidgets", "shinycssloaders", "markdown", "DT", "arrow", "leaflet", "bslib", "fresh", "sass", "reactlog", "shinytest2", "diffviewer", "palmerpenguins", "lterdatasampler", "gapminder"))
```
