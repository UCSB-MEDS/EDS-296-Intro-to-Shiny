...
We'll be building / playing with a number of small apps and dashboards throughout this workshop. The lecture slides include all necessary code, but you may also reference the complete source code for each app on [GitHub](https://github.com/samanthacsik/EDS-296-shiny-apps){target="_blank"}. 
